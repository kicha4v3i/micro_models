...
// Calculations
const maxSurfacePress = computed(() => {
    //Base Units
    ...
    // Calculations
    if (maxPressUnit.value == 'psi') {
        return (0.2 * Math.sqrt(formPressBaseUnit * pitGainBaseUnit * kmwBaseUnit / annCap)).toFixed(0)
    } else {
        return (0.2 / 0.145 * Math.sqrt(formPressBaseUnit * pitGainBaseUnit * kmwBaseUnit / annCap)).toFixed(0)
    }
})
</script>
    ...
    <div class="d-flex justify-content-between align-items-start">
        <div class="data-show d-flex ms-5 mt-5 align-items-center">
            <div class="inputs w-50">
                <h3 class="fs-5 w-75">Max Surface Pressure from Gas Kick with WBM</h3>
            ...
            <div class="outputs ms-1">
                <div class="lp-height d-flex align-items-end">
                    <div class="lp-height-out">
                        <span class="text-secondary text-uppercase fs-6">Max Surface Pressure</span>
                        <h3 class="text-center text-success">{{ maxSurfacePress }}</h3>
                    </div>
                    <div class="lp-height-unit">
                        <span>
                            <select class="form-select" v-model="maxPressUnit">
                                <option>psi</option>
                                <option>kPa</option>
                            </select>
                        </span>
